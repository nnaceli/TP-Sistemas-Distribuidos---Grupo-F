...
public final class LoginServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Login.LoginRequest,
      Login.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Login",
      requestType = Login.LoginRequest.class,
      responseType = Login.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Login.LoginRequest,
      Login.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<Login.LoginRequest, Login.LoginResponse> getLoginMethod;
